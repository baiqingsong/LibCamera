package com.dawn.camera.custom;
...
import com.dawn.camera.R;
import com.dawn.camera.custom.util.GlUtil;
import com.dawn.camera.gles.ProgramLandmarks;
import com.dawn.camera.gles.ProgramTexture2d;
import com.dawn.camera.gles.ProgramTextureOES;
...
public class BaseCameraRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        if (mViewWidth != width || mViewHeight != height) {
            mMvpMatrix = GlUtil.changeMVPMatrixCrop(width, height, mCameraWidth, mCameraHeight);
            if(CameraUtil.takePhotoOrientation != 0)//0拍照镜像显示，1拍照同向显示
