...
import com.dawn.camera.entity.Effect;
import com.dawn.camera.entity.LightMakeupItem;
import com.dawn.camera.entity.MakeupEntity;
import com.dawn.camera.param.BeautificationParam;
import com.dawn.camera.param.BodySlimParam;
import com.dawn.camera.param.CartoonFilterParam;
import com.dawn.camera.param.HairParam;
import com.dawn.camera.param.MakeupParamHelper;
...
//    private static final String BUNDLE_TONGUE = GRAPHICS_ASSETS_DIR + "tongue.bundle";
    ...
    private onFUCompleteListener mOnFUCompleteListener;
     ...
     */
    public static void initFURenderer(Context context, byte[] authpack) {
        if (sIsInited) {
            return;
        }
        ...
        // 获取 Nama SDK 版本信息
        Log.e("dawn", "fu sdk version " + faceunity.fuGetVersion());
        int isSetup = faceunity.fuSetup(new byte[0], authpack);
...
//                Log.w(TAG, "readFile: e2", e2);
    ...
    public void onSurfaceCreated() {
        ...
        Log.i("dawn", "rotation mode : " + rotationMode);
        // TODO 人脸识别方向
        faceunity.fuSetDefaultRotationMode(0);//0是正显示，2是反着显示
...
//            Log.v("anyzhou", "prepareDrawFrame: face beauty params: isBeautyOn:" + sIsBeautyOn + ", filterName:"
...
//                    + sMicroLongNose + ", microEyeSpace:" + sMicroEyeSpace + ", eyeRotate:" + sMicroEyeRotate);
    ...
    public void setTrackOrientation(final int rotation) {
        Log.i("dawn", "device orientation " + rotation);
        if (mDeviceOrientation != rotation) {
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    mRotationMode = rotationMode;
                    Log.i("dawn", "setTrackOrientation. deviceOrientation: " + mDeviceOrientation + ", rotationMode: " + mRotationMode);
    ...
    public void setFilterLevel(float mFilterLevel) {
        this.mFilterLevel = mFilterLevel;
    }

    public void setNeedUpdate(boolean needUpdate) {
        this.mIsNeedUpdateFaceBeauty = needUpdate;
    }
    ...
    public interface onFUCompleteListener {
        /**
         * bundle 加载完成
         */
    ...
    public static class Builder {
        ...
        private onFUCompleteListener onFUCompleteListener;
        ...
        private boolean mIsLoadAiGesture;
        private boolean mIsLoadAiHumanProcessor;
        private String sFilterName = BeautificationParam.ORIGIN;
        ...
        public Builder setFilterName(String sFilterName) {
            this.sFilterName = sFilterName;
            return this;
        }

        public Builder setFilterLevel(float mFilterLevel) {
            this.mFilterLevel = mFilterLevel;
            return this;
        }

        public Builder setNeedUpdate(boolean needUpdate) {
            this.mIsNeedUpdateFaceBeauty = needUpdate;
            return this;
        }
        ...
        public Builder setFUCompleteListener(onFUCompleteListener fuCompleteListener) {
            this.onFUCompleteListener = fuCompleteListener;
            return this;
        }
        ...
        public FURenderer build() {
            ...
            fuRenderer.mOnFUCompleteListener = onFUCompleteListener;
            fuRenderer.mIsLoadAiGesture = mIsLoadAiGesture;
            fuRenderer.mIsLoadAiHumanProcessor = mIsLoadAiHumanProcessor;
            fuRenderer.sFilterName = sFilterName;
            fuRenderer.mFilterLevel = mFilterLevel;
            return fuRenderer;
        }
    }
...
//                break;
    ...
    public void getMsg(Context context, String bundlePath){
        int systemError = faceunity.fuGetSystemError();
        Log.e("dawn", "system error :" + systemError);
        int packageError = faceunity.fuCreateItemFromPackage(readFile(context, bundlePath));
        Log.e("dawn", "package error " + packageError);
        int trackError = faceunity.fuIsTracking();
        Log.e("dawn", "track error : " + trackError);
        int humanError = faceunity.fuHumanProcessorGetNumResults();
        Log.e("dawn", "human error : " + humanError);
        String version = faceunity.fuGetVersion();
        Log.e("dawn", "face sdk version :" + version);
    }
    ...
    public void printLog(){
        int humanError = faceunity.fuHumanProcessorGetNumResults();
        Log.e("dawn", "human log : " + humanError);
    }
}
