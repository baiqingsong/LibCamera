...
import com.dawn.beauty.record.media.video.encoder.MediaAudioEncoder;
import com.dawn.beauty.record.media.video.encoder.MediaEncoder;
import com.dawn.beauty.record.media.video.encoder.MediaMuxerWrapper;
import com.dawn.beauty.record.media.video.encoder.MediaVideoEncoder;
import com.dawn.beauty.record.utils.DecimalUtils;
import com.dawn.beauty.utils.FileUtils;
...
public class VideoRecordHelper {
    ...
    private int videoOrientation = 180;//文件朝向
