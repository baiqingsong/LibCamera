...
package com.dawn.beauty.custom.util;
...
//        Log.i("dawn", "get default display rotation : " + rotation);
        int degrees = 0;
        switch (rotation) {
        ...
        Log.i("dawn", "set display orientation " + result);
...
//    public static String getPhotoBitmap(Bitmap bitmap){
//        if(bitmap == null)
//            return null;
